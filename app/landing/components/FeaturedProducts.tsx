...
export default function FeaturedProducts({ title, products: initialProducts }: FeaturedProductsProps) {
  const [currentIndex, setCurrentIndex] = useState(0);
  const [favorites, setFavorites] = useState<{ [key: number]: boolean }>({});

  // Default mock data - will be replaced with backend data
  const mockProducts: Product[] = [
    {
      id: 1,
      name: 'Fellowes Wellness - Floor Mat Plush',
      price: 150,
    ...
    {
      id: 3,
      name: 'SUBARU NOTEBOOK Flexible Binding - 4 Supplies',
      price: 150,
    ...
    {
      id: 4,
      name: 'Dial Antibacterial Foaming Hand Wash, Spring Water, 7.5 Fl Oz',
      price: 150,
  ...
  const products = initialProducts || mockProducts;
