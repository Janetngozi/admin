...
export default function GovernmentSignIn() {
  ...
  const handleSignIn = (): void => {
    setIsLoading(true);
    setErrorMessage('');
    // Demo sign-in behaviour: replace with real auth call
    // For now any credentials other than the demo one will show the error banner
    setTimeout(() => {
      // Demo successful credential (adjust as needed)
      const demoEmail = 'johndoe123@gmail.com';
      const demoPassword = 'password123';

      if (email === demoEmail && password === demoPassword) {
        // TODO: redirect to dashboard or proceed
        console.log('Signed in (demo)');
        setErrorMessage('');
      } else {
      ...
      <div className="w-full lg:w-1/2 lg:ml-auto flex items-center justify-center min-h-screen p-4 overflow-y-auto">
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                ...
                <a href="/auth/signin/government/forgotpassword" className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-center text-gray-600 text-xs mt-8">
            ...
            <a href="/auth/signup/government" className="text-blue-600 hover:text-blue-700 font-semibold">
              Sign Up
            </a>
          </p>
        </div>
