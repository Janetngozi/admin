    ...
    if (otp.every((digit) => digit !== '')) {
      ...
      setTimeout(() => {
        ...
        if (entered === demoValid) {
          router.push('/auth/signin/government/resetpassword');
          setErrorMessage('');
        ...
        <div className="w-full max-w-md">
         ...
         {/* Timer or Resend Button */}
          ...
          <div className="text-center mb-8">
            ...
            <a href="/auth/signin/government/forgotpassword" className="text-blue-600 hover:text-blue-700 font-semibold text-sm">
              Edit Email
            </a>
          </div>
