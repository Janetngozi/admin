...
export default function PersonalSignUp() {
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    console.log('Sign up details:', { firstName, lastName, email });

    // Simulate API call
    setTimeout(() => {
      setIsLoading(false);
      // Store details and go to create password page
      router.push('/auth/signup/personal/createpassword');
    }, 1000);
  };
      ...
      <div className="w-full lg:w-1/2 lg:ml-auto flex items-center justify-center min-h-screen p-4 overflow-y-auto relative">
        ...
        <div className={`w-full max-w-md ${errorMessage ? 'opacity-50 transition-opacity' : ''}`}>
          ...
          <p className="text-center text-gray-600 text-xs mb-8">
            A few quick details and you'll be ready to shop smarter.
          </p>
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200"
            >
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-sm">Sign Up With Apple</span>
            </button>
          </div>
          ...
          <p className="text-center text-gray-600 text-xs mt-8">
            ...
            <a href="/auth/signin/personal" className="text-blue-600 hover:text-blue-700 font-semibold">
              Sign In
            </a>
          </p>
        </div>
